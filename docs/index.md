# 【2020 年 10 月】ゲーム開発 / プログラミングにおすすめのノート PC（学生向け）

- ゲーム開発やプログラミングをしたいけど、PC を買う予算が限られている小学生～大学生のための、価格帯別コスパ最高 PC リストです。性能を最重視しています
- 表示価格はオンラインストアでの価格で、**税込み・送料込み・学割適用済み** です
- キャンペーン等により価格は変動します
- 学割の使用方法は [学割](https://notebookjp.github.io/student/gakuwari/) ページを参照
- 情報提供は [GitHub](https://github.com/Reputeless/Laptops) の Issue や Pull-Request でお送りください
...
- Model: IdeaPad S340(14) (第10世代インテル) (81VV000VJP)
- Release: 2019-09
- OS: Windows 10 Home (64-bit) 
...
- Model: IdeaPad Slim 550 (14) (81YM009PJP)
- Release: **2020-07**
- OS: Windows 10 Home (64-bit) 
- CPU: Ryzen 7 4700U / **8C8T** / **2.0GHz～4.1GHz** / **4MB L2 + 8MB L3**
- iGPU: **Radeon RX Vega 7** / 7 CUs (448 pipelines) / ～**1.6 GHz**
...
- Model: New Inspiron 13 5000 (5301)
- Release: **2020-10**
- OS: Windows 10 Home (64-bit) 
...
- Model: ASUS ROG Zephyrus G15 (GA502DU-R7G1660AS)
- Release: **2020-08**
- OS: Windows 10 Home (64-bit) 
- CPU: Ryzen 7 3750H / 4C8T / **2.3GHz**～4.0GHz / 4MB L3
...
- Model: Legion Y7000 (第9世代インテル) (81NS000HJP)
- Release: 2019-06
- OS: Windows 10 Home (64-bit) 
...
- Model: Legion Y7000 (第9世代インテル) (81NS005FJP)
- Release: 2020-01
- OS: Windows 10 Home (64-bit) 
